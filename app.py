...
if not model_loaded:
    st.error("⚠️ Model files not found! Please run `save_model.py` in your notebook first to generate `rf_model.pkl` and `model_columns.pkl`.")
    st.stop()
...
<div style="text-align:center; color:#4a5568; font-size:0.8rem; font-family:'Space Mono', monospace;">
    ...
    Random Forest Classifier · AUC: 0.795 · 5-Fold CV F1: 0.704
</div>
""", unsafe_allow_html=True)
